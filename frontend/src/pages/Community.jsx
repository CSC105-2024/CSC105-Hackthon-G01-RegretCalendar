  ...
  return (
    <div className="bg-[#F0F4F5] min-h-screen font-inter">
      ...
      <div className="flex flex-col items-center mt-5">
        <h1 className="text-4xl font-bold text-[#5E8B7E] mb-4">Community Reflection</h1>
        <p className="text-lg text-[#6E6E6E]">Share your reflections anonymously and learn from the experiences<br></br> of others. This is a space for collective growth and understanding.</p>
      </div>
